...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<script src="//cdnjs.cloudflare.com/ajax/libs/formvalidation/0.6.2-dev/css/formValidation.min.css"></script>
				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								<li><a href="{{URL ::to('/manage-order')}}">Manage Bill Order</a></li>
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								...
								<li><a href="{{URL::to('/all-brand-product')}}">List of brand product</a></li>
